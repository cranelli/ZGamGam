...
#ifndef CommonFiducialSkim_h
#define CommonFiducialSkim_h
...
public :
   ...
   CommonFiducialSkim(TTree *tree=0);
   virtual ~CommonFiducialSkim();
...
#ifdef CommonFiducialSkim_cxx
CommonFiducialSkim::CommonFiducialSkim(TTree *tree) : fChain(0) 
{
...
CommonFiducialSkim::~CommonFiducialSkim()
{
   if (!fChain) return;
...
/*
Int_t CommonFiducialSkim::GetEntry(Long64_t entry)
{
...
*/
 ...
 /*
Long64_t CommonFiducialSkim::LoadTree(Long64_t entry)
{
...
void CommonFiducialSkim::Init(TTree *tree)
{
...
#endif // #ifdef CommonFiducialSkim_cxx
